...
const Order = () => {
    const [isBuy, setIsBuy] = useState(true) // ability to set ordeer info w price and amount
      ...
      <div className="component exchange__orders">
        <div className='component__header flex-between'>
          ...
          <div className='tabs'>
            ...
            <button onClick={tabHandler} ref={sellRef} className='tab tab--active'>Sell</button>         
          </div>
        </div>
